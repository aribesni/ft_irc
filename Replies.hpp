...
# include "Client.hpp"
	...
	class Replies {
		...
		public :
			...
			/* "353" */ std::string RPL_NAMREPLY() { return (":" + this->_prefix + " 353 " + this->_nickname + " " + "( '=' / '*' / '@' )" + this->_channel + " ' ' : [ '@' / '+' ] " + this->_nickname + " *( ' ' [ '@' / '+' ] " + this->_nickname + " )" + "\r\n"); };
			...
			/* "366" */ std::string RPL_ENDOFNAMES() { return (":" + this->_prefix + " 366 " + this->_nickname + " " + this->_channel + " :<info>" + "\r\n"); };
			...
			/* "442" */ std::string ERR_NOTONCHANNEL() { return (":" + this->_prefix + " 442 " + this->_nickname + " " + this->_channel + " :<reason>" + "\r\n"); };
			...
			/* "482" */ std::string ERR_CHANOPRIVSNEEDED() { return (":" + this->_prefix + " 482 " + this->_nickname + " " + this->_channel + " :<reason>" + "\r\n"); };
