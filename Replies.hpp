...
/*   Updated: 2023/04/21 11:55:36 by gduchate         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# include "Client.hpp"
	...
	class Replies {
		...
		public :
			...
			/* "318" */ std::string RPL_ENDOFWHOIS(std::string nick) { return (":" + this->_prefix + " 318 " + this->_nickname + " " + nick + " :End of /WHOIS list" + "\r\n"); };
			...
			/* "476" */ std::string ERR_BADCHANMASK(std::string channel) { return (":" + this->_prefix + " 476 " + this->_nickname + " " + channel + " :Bad Channel Mask" + "\r\n"); };
